          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="space-y-2.5 sm:space-y-3">
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-amber-50/50 border border-amber-200 rounded-xl text-stone-800 placeholder:text-stone-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5500]/30 focus-visible:border-[#FF5500] text-sm sm:text-base px-4 py-3 transition-all resize-none"
              />
            </div>
